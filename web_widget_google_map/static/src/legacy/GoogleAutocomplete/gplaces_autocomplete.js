odoo.define('web_widget_google_map.GplaceAutocompleteFields', function (require) {
    'use strict';


    console.log(' [web_widget_google_map.GplaceAutocompleteFields] ');

    const BasicFields = require('web.basic_fields');
    const core = require('web.core');
    const Utils = require('web_widget_google_map.Utils');
    const _t = core._t;

    const GplaceAutocomplete = BasicFields.FieldChar.extend({
        // tagName: 'span',
