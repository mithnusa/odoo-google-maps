...
export class BaseGoogleMapModel extends RelationalModel {
    /**
     * Override
     * @param {*} params
     * @param {*} services
    ...
    _getNextConfig(currentConfig, params) {
        ...
        const mapDomain = this.getMapDomain();
        if (mapDomain) {
...
BaseGoogleMapModel.Group = GoogleMapGroup;
BaseGoogleMapModel.DynamicGroupList = GoogleMapDynamicGroupList;
BaseGoogleMapModel.Record = GoogleMapRecord;
