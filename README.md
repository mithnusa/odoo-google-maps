...
|--------|---------|-------------|
| [base_google_map](/base_google_map/README.md) | 19.0.1.0.1 | Base module of Google Maps contains settings to setup Google API Key |
...
| [contacts_google_map](/contacts_google_map/README.md) | 19.0.1.0.2 | Implementation of view "Google Maps" on Contacts |
...
| [web_view_google_map](/web_view_google_map/README.md) | 19.0.1.0.4 | Base module for a new view "google_map" |
| [web_view_google_map_drawing](/web_view_google_map_drawing/README.md) | 19.0.1.0.3 | Base module for sub view of "google_map" for drawing capability |
| [sale_google_map](/sale_google_map/README.md) | 19.0.1.0.4 | Implementation of view "Google Maps" on Sale Order |
