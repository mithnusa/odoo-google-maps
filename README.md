...
|--------|---------|-------------|
| [base_google_map](/base_google_map/README.md) | 19.0.1.0.5 | Base module of Google Maps contains settings to setup Google API Key |
...
| [partner_autocomplete_with_google_autocomplete](/partner_autocomplete_with_google_autocomplete/README.md) | 19.0.1.0.1 | Implementation of Google Places Autocomplete along with existing Odoo Partner Autocomplete on Contact form |
...
| [web_widget_google_place_autocomplete](/web_widget_google_place_autocomplete/README.md) | 19.0.1.0.3 | Implementation of Google Places Autocomplete Element |
