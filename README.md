...
|--------|---------|-------------|
| [base_google_map](/base_google_map/README.md) | 19.0.1.0.7 | Base module of Google Maps contains settings to setup Google API Key |
...
| [web_view_google_map](/web_view_google_map/README.md) | 19.0.1.0.14 | Base module for a new view "google_map" |
