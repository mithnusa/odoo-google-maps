...
|--------|---------|-------------|
| [base_google_map](/base_google_map/README.md) | 19.0.1.0.6 | Base module of Google Maps contains settings to setup Google API Key |
...
| [web_widget_google_place_autocomplete](/web_widget_google_place_autocomplete/README.md) | 19.0.1.0.4 | Implementation of Google Places Autocomplete Element |
