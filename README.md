...
| base_google_places | Base module of Google places, inherit base_google_maps, contains abstract model to store place info |
| contacts_gautocomplete_address_form | Implementation of widget Google address form autocomplete on Contacts |
| contacts_gautocomplete_address_form_extended | Inherit contacts_gautocomplete_address_form and add more data to a contact about a place from Google Place such as Google Address, Place ID, Place URL, Opening Hours, Types, Global Code, Compound Code, Plus Code URL, and Vicinity |
| contacts_gautocomplete_places | Implementation of widget Google places autocomplete on Contacts |
| contacts_gautocomplete_places_extended | Inherit contacts_gautocomplete_places and add more data to a contact about a place from Google Place such as Google Address, Place ID, Place URL, Opening Hours, Types, Global Code, Compound Code, Plus Code URL, and Vicinity |
...
| crm_gautocomplete_address_form_extended | Inherit crm_gautocomplete_address_form and add more data to a lead about a place from Google Place such as Google Address, Place ID, Place URL, Opening Hours, Types, Global Code, Compound Code, Plus Code URL, and Vicinity |
| crm_gautocomplete_places | Implementation of widget Google places autocomplete on CRM |
| crm_gautocomplete_places_extended | Inherit crm_gautocomplete_places and add more data to a lead about a place from Google Place such as Google Address, Place ID, Place URL, Opening Hours, Types, Global Code, Compound Code, Plus Code URL, and Vicinity |
...
| web_widget_google_places | Inherit web_widget_google_map and add more data from Google Places |
