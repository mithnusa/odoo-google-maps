...
- **[base_google_map_add_place](base_google_map_add_place/README.md)** `19.0.1.0.2` — Abstract base for the click-to-create workflow. Provides the `google_map.add_place.mixin` Python mixin and the `InMapClickAddPlace` OWL component with zoom threshold logic and smart zoom shortcut. Application modules extend this instead of re-implementing the pattern.
