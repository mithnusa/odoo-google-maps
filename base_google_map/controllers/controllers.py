...
class Main(http.Controller):
    ...
    def map_setting(self):
        ...
        is_places_search_enable = safe_eval(
            IrParam.get_param('base_google_map.enable_map_place_search', default='False')
        )
        ...
        is_restrict_country = safe_eval(
            IrParam.get_param('base_google_map.autocomplete_country_restrict', default='False')
        )
        values['autocomplete_restrict_country'] = is_restrict_country

        country_codes = IrParam.get_param('base_google_map.autocomplete_country_restriction', default='')
